...
-**Enhanced function**
1.Support outupt console info to log file.
2.Enhances Undo/redo function.
3.Simplified preference widget.
4.Support show curve which is shaded by part.
5.Support create topo shape relationship which is not support by opencascade.
6.Update some codes from 0.19 to 0.21
7.Support some class inheritable for extension.
8.Fix some bugs.

⚠ **Disclaimer**:  
This is a **third-party derivative** of FreeCAD and is **not affiliated** with the official FreeCAD project.
